...
static void app_scene_sorry_draw_callback(void* context) {
    App* app = context;
...
void app_scene_sorry_on_enter(void* context) {
    ...
    animation_set_animation(
        app->animation, &A_Sorry_128x64, 0, 0, animation_reverse_repeat, animation_play_once);
...
void app_scene_sorry_on_event(void* context, SceneEvent event) {
    App* app = context;
...
void app_scene_sorry_on_exit(void* context) {
    App* app = context;
